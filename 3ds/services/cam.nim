...
type
  CAMU_Port* = enum
    ...
    PORT_BOTH = PORT_CAM1 or PORT_CAM2
...
type
  CAMU_CameraSelect* = enum
    SELECT_NONE = 0x00000000, SELECT_OUT1 = BIT(0), SELECT_IN1 = BIT(1), SELECT_OUT2 = BIT(
        2),                   # Camera combinations.
    SELECT_IN1_OUT1 = SELECT_OUT1 or SELECT_IN1,
    SELECT_OUT1_OUT2 = SELECT_OUT1 or SELECT_OUT2,
    SELECT_IN1_OUT2 = SELECT_IN1 or SELECT_OUT2,
    SELECT_ALL = SELECT_OUT1 or SELECT_IN1 or SELECT_OUT2
...
type
  CAMU_Context* = enum
    ...
    CONTEXT_BOTH = CONTEXT_A or CONTEXT_B
...
proc CAMU_SetPackageParameterWithoutContext*(
    param: CAMU_PackageParameterCameraSelect): Result
