...
proc GPU_Init*(gsphandle: ptr Handle)
proc GPU_Reset*(gxbuf: ptr u32; gpuBuf: ptr u32; gpuBufSize: u32)
#GPUCMD
...
proc GPUCMD_SetBuffer*(adr: ptr u32; size: u32; offset: u32)
proc GPUCMD_SetBufferOffset*(offset: u32)
proc GPUCMD_GetBuffer*(adr: ptr ptr u32; size: ptr u32; offset: ptr u32)
proc GPUCMD_AddRawCommands*(cmd: ptr u32; size: u32)
proc GPUCMD_Run*(gxbuf: ptr u32)
proc GPUCMD_FlushAndRun*(gxbuf: ptr u32)
proc GPUCMD_Add*(header: u32; param: ptr u32; paramlength: u32)
proc GPUCMD_Finalize*()
...
type
  GPU_TEXTURE_FILTER_PARAM* = enum
    GPU_NEAREST = 0x00000000, GPU_LINEAR = 0x00000001
  GPU_TEXTURE_WRAP_PARAM* = enum
...
proc GPU_SetViewport*(depthBuffer: ptr u32; colorBuffer: ptr u32; x: u32; y: u32; w: u32;
                     h: u32)
proc GPU_SetScissorTest*(mode: GPU_SCISSORMODE; x: u32; y: u32; w: u32; h: u32)
proc GPU_DepthMap*(zScale: cfloat; zOffset: cfloat)
proc GPU_SetAlphaTest*(enable: bool; function: GPU_TESTFUNC; `ref`: u8)
...
proc GPU_SetColorLogicOp*(op: GPU_LOGICOP)
proc GPU_SetBlendingColor*(r: u8; g: u8; b: u8; a: u8)
proc GPU_SetAttributeBuffers*(totalAttributes: u8; baseAddress: ptr u32;
                             ...
                             bufferNumAttributes: ptr u8)
proc GPU_SetTextureEnable*(units: GPU_TEXUNIT)
...
proc GPU_SetTexEnv*(id: u8; rgbSources: u16; alphaSources: u16; rgbOperands: u16;
                   ...
                   alphaCombine: GPU_COMBINEFUNC; constantColor: u32)
proc GPU_DrawArray*(primitive: GPU_Primitive_t; first: u32; count: u32)
proc GPU_DrawElements*(primitive: GPU_Primitive_t; indexArray: ptr u32; n: u32)
proc GPU_FinishDrawing*()
proc GPU_SetShaderOutmap*(outmapData: array[8, u32])
